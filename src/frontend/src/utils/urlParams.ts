...
/**
 * Stores the rooms display count in sessionStorage
...
/**
 * Gets the stored show hidden rooms preference from sessionStorage
...
/**
 * Stores the show hidden rooms preference in sessionStorage
